...
add_action( 'admin_init', function() {
	add_settings_section(
		...
		'custom_stock_statuses_textarea_callback',
		'custom-product-stock-statuses-for-woocommerce'
	);
	add_settings_field(
		'custom-product-stock-statuses-for-woocommerce',
...
add_action('admin_menu', 'register_custom_stock_status_submenu_page');

function custom_stock_statuses_textarea_callback( $arguments ) {
	?>
	<label for="custom-product-stock-statuses-for-woocommerce-stock-statuses">
		Enter your stock statuses. Put each one on a new line.
	</label>
	<br />
...
<?= esc_textarea( get_option( 'custom-product-stock-statuses-for-woocommerce-stock-statuses' ) ) ?>
	</textarea>
	<?php
}

function register_custom_stock_status_submenu_page() {
	add_submenu_page( 'woocommerce', 'Custom stock statuses', 'Custom stock statuses', 'manage_options', 'custom-stock-statuses', 'custom_stock_status_page' );
}

function custom_stock_status_page() {
	?>
	<div class="wrap">
...
function filter_custom_woocommerce_product_stock_status_options( $status ) {
...
add_filter( 'woocommerce_product_stock_status_options', 'filter_custom_woocommerce_product_stock_status_options', 10, 1 );
